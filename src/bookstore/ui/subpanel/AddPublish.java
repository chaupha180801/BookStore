...
import bookstore.database.tables.Publisher;
import javax.swing.JOptionPane;
import bookstore.exceptions.DatabasePermissonErrorException;
public class AddPublish extends javax.swing.JFrame {

    /** Creates new form AddPublish */
    protected void initialize(PublisherPanel parent){
        this.parent = parent;
        this.setLocationRelativeTo(null);
        this.idTextField.setEditable(false);
        this.idTextField.setFocusable(false);
    }
    public AddPublish(PublisherPanel parent) {
        this.initComponents();
        this.initialize(parent);
        this.action = 0;
    }
    public AddPublish(PublisherPanel parent, Publisher publisher){
        this.initComponents();
        this.initialize(parent);

        this.idTextField.setText(publisher.getId());
        this.nameTextField.setText(publisher.getName());
        this.addressTextField.setText(publisher.getAddress());
        this.phoneNumberTextField.setText(publisher.getPhoneNumber());
    ...
    private void initComponents() {
        ...
        informationPanel.setPreferredSize(new java.awt.Dimension(200, 200));
        ...
        nameLabel.setText("Tên nhà xuất bản");
        ...
        idLabel.setText("Mã nhà xuất bản");
        ...
        informationPanelLayout.setHorizontalGroup(
            ...
            .add(informationPanelLayout.createSequentialGroup()
                ...
                .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, phoneNumberTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 340, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
    ...
    private Publisher getPublisher(){
     ...
     private void addPublisher(Publisher publisher){
        if (publisher.getName().isEmpty() 
            || publisher.getAddress().isEmpty()
            || publisher.getPhoneNumber().isEmpty()
        ){
            JOptionPane.showMessageDialog(null, "Bạn cần nhập đầy đủ thông tin.", "Nhập thông tin", 1);
        }
        else{
            try{
                if (Publisher.insert(publisher)){
                    JOptionPane.showMessageDialog(null, "Dữ liệu đã được thêm.", "Thêm nhã xuất bản", 1);
                    this.parent.reloadTable();
                }
                else 
                    JOptionPane.showMessageDialog(null, "Dữ liệu không được thêm.", "Lỗi thêm nhà xuất bản", 1);
