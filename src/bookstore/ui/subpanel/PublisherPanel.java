...
public class PublisherPanel extends javax.swing.JPanel {
    ...
    public void renderTable(ArrayList<Publisher> publishers){
        String[] columnName = {"Mã nhà xuất bản", "Tên nhà xuất bản", "Địa chỉ", "SĐT"};
        // 4 la số cột
        Object[][] rows = new Object[publishers.size()][4];
        
        for(int i = 0; i < publishers.size(); i ++){
            rows[i][0] = publishers.get(i).getId();
            rows[i][1] = publishers.get(i).getName();
            rows[i][2] = publishers.get(i).getAddress();
            rows[i][3] = publishers.get(i).getPhoneNumber();
        }
        DefaultTableModel model = new DefaultTableModel(rows, columnName);
        this.table.setModel(model);
    }
    public Publisher getSelectedRowInTable(){
        ...
        String phonenumber = this.table.getValueAt(row,3).toString();
        return new Publisher(id, name, address, phonenumber);
    }
    public void reloadTable(){
        try{
            ArrayList<Publisher> publishers = Publisher.selectAll();
            this.renderTable(publishers);
        }catch(DatabasePermissonErrorException ex){
    ...
    private void initComponents() {
        ...
        titleLabel.setText("QUẢN LÝ THÔNG TIN NHÀ XUẤT BẢN");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        try{
            Publisher publisher = this.getSelectedRowInTable();
            ...
            int option = JOptionPane.showConfirmDialog(
                null,
                "Bạn có chắc muốn xóa " + publisher.getName() + " không? ",
                "Xóa",
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        // TODO add your handling code here:
        AddPublish addPublish= new AddPublish(this);
        addPublish.show();
    }//GEN-LAST:event_addButtonActionPerformed

    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        // TODO add your handling code here:\
        Publisher publish = this.getSelectedRowInTable();

        if (publish == null)
        return;

        AddPublish addPublish= new AddPublish(this, publish);
        addPublish.show();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try{
            ...
            ArrayList<Publisher> publishers = Publisher.findByName(input,false);
            this.renderTable(publishers);
        }catch(DatabasePermissonErrorException ex){
           JOptionPane.showMessageDialog(null,
