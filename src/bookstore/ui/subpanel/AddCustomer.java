...
import bookstore.database.tables.Customer;
...
public class AddCustomer extends javax.swing.JFrame {
    ...
    protected void initialize(CustomerPanel parent){
        this.parent = parent;
    ...
    public AddCustomer(CustomerPanel parent) {
        this.initComponents();
        this.initialize(parent);
        this.action = 0;
    }
    
     public AddCustomer(CustomerPanel parent, Customer customer){
        this.initComponents();
        this.initialize(parent);

        this.idTextField.setText(customer.getId());
        this.nameTextField.setText(customer.getName());
        this.typeOfCustomerTextField.setText(String.valueOf(customer.getTypeOfCustomer()));
        this.addressTextField.setText(customer.getAddress());
        this.phoneNumberTextField.setText(customer.getPhoneNumber());
        //this.debtTextField.setText(String.valueOf(customer.getDebt()));
    ...
    private void initComponents() {
        ...
        typeOfCustomerTextField = new javax.swing.JTextField();
        phoneNumberTextField = new javax.swing.JTextField();
        phoneNumberLabel = new javax.swing.JLabel();
        addressLabel = new javax.swing.JLabel();
        typeOfCustomerLabel = new javax.swing.JLabel();
        ...
        mainPanel.setMinimumSize(new java.awt.Dimension(600, 380));
        mainPanel.setPreferredSize(new java.awt.Dimension(600, 380));
        mainPanel.setLayout(new javax.swing.BoxLayout(mainPanel, javax.swing.BoxLayout.PAGE_AXIS));

        informationPanel.setBackground(new java.awt.Color(255, 255, 255));
        informationPanel.setMaximumSize(new java.awt.Dimension(32000, 32000));
        informationPanel.setName("Thêm tác giả"); // NOI18N
        informationPanel.setPreferredSize(new java.awt.Dimension(250, 200));
        ...
        typeOfCustomerTextField.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        typeOfCustomerTextField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        typeOfCustomerTextField.setToolTipText("");
        typeOfCustomerTextField.setMaximumSize(new java.awt.Dimension(300, 40));
        typeOfCustomerTextField.setMinimumSize(new java.awt.Dimension(300, 40));
        typeOfCustomerTextField.setPreferredSize(new java.awt.Dimension(300, 40));
        ...
        typeOfCustomerLabel.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        typeOfCustomerLabel.setText("Loại khách hàng");
        typeOfCustomerLabel.setFocusable(false);
        typeOfCustomerLabel.setMaximumSize(new java.awt.Dimension(200, 40));
        typeOfCustomerLabel.setMinimumSize(new java.awt.Dimension(200, 40));
        typeOfCustomerLabel.setPreferredSize(new java.awt.Dimension(200, 40));
        typeOfCustomerLabel.setRequestFocusEnabled(false);

        nameLabel.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        nameLabel.setText("Tên khách hàng");
            ...
            .add(informationPanelLayout.createSequentialGroup()
                ...
                .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        ...
                        .add(typeOfCustomerLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 120, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                ...
                .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(typeOfCustomerTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, addressTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE))
        ...
        informationPanelLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, informationPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(typeOfCustomerLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(typeOfCustomerTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(informationPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
        ...
        choosePanel.setMaximumSize(new java.awt.Dimension(32000, 32000));
        choosePanel.setPreferredSize(new java.awt.Dimension(152, 10));
    ...
    private Customer getCustomer(){
            ...
            int typeOfCustomer = Integer.valueOf(this.typeOfCustomerTextField.getText());
            String address = this.addressTextField.getText();
            String phonenumber = this.phoneNumberTextField.getText();
            return new Customer(id, name, typeOfCustomer, address, phonenumber, 0);
    }
    ...
    private void addCustomer(Customer customer){
        if (customer.getName().isEmpty() 
            ...
            || String.valueOf(customer.getDebt()).isEmpty()
            || String.valueOf(customer.getTypeOfCustomer()).isEmpty()
        ){
            ...
            try{
                if (Customer.insert(customer)){
                    JOptionPane.showMessageDialog(null, "Dữ liệu đã được thêm.", "Thêm khách hàng", 1);
                    this.parent.reloadTable();
                }
                else 
                    JOptionPane.showMessageDialog(null, "Dữ liệu không được thêm.", "Lỗi thêm khách hàng", 1);
    ...
    private javax.swing.JLabel typeOfCustomerLabel;
    private javax.swing.JTextField typeOfCustomerTextField;
